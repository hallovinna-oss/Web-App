 ...
 * Centralizes environment, campus, and student configuration.
 */
...
const APP_CONFIG = {
  ...
  campuses: (function () {
    try {
      // Prefer explicit module-based campuses when available (dev/prod builds)
      // Importing at build time is ideal; fall back to window global when absent.
      // Note: dynamic import isn't used here to keep the module synchronous.
      if (typeof window !== 'undefined' && Array.isArray(window.MIPHA_CAMPUSES)) return window.MIPHA_CAMPUSES;
    } catch (e) {}
    // Default official campuses (kept here as a fallback)
    return [
      { id: 'campus_1', name: 'SMK Bhumi Phala Kampus 1', lat: -7.281462945129072, lng: 110.09827607588974, radiusMeters: 100 },
      { id: 'campus_2', name: 'SMK Bhumi Phala Kampus 2', lat: -7.282467, lng: 110.096915, radiusMeters: 100 }
    ];
  })(),
...
window.MIPHA_CONFIG = APP_CONFIG;

export default APP_CONFIG;
export const SCHOOL_CONFIG = APP_CONFIG.school;
export const INITIAL_STUDENTS = APP_CONFIG.initialStudents;
