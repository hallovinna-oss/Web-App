...
const AppState = {
      ...
      <div class="login-container">
        <div class="login-card fade-in">
          ...
          <div style="margin-top: 1rem; text-align: center; font-size: 0.78rem; color: var(--text-muted); border-top: 1px solid var(--border-light); padding-top: 1rem;">
            MIPHA Companion v1.0 RC4 · Production Edition<br>Radius Sekolah Target: <b>75 Meter</b> | Jam Masuk: <b>07.00 WIB</b>
          </div>
        </div>
      </div>
    `;
    ...
    return `
      <div class="card">
        ...
        <p style="font-size: 0.85rem; color: var(--text-muted); margin-bottom: 1rem;">
          Ketentuan Presensi Sekolah: Radius Maksimal <b>75 Meter</b>. Batas Tepat Waktu <b>07.00 WIB</b>.
        </p>
  ...
  async exportOfficialAttendanceXLSX() {
    try {
      ...
      workbook.creator = 'MIPHA Companion RC4';
      ...
      generatedCell.value = `Generated by MIPHA Companion RC4   Export Date: ${new Date().toLocaleString('id-ID')}`;
